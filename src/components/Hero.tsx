...
export const Hero: React.FC = () => {
  ...
  const handleResumeView = () => {
    try {
      ...
      window.open('https://drive.google.com/file/d/1KK6MZNntzPbGbMrHqj9TWK92-DaD61Nw/view', '_blank');
    } catch (error) {
  ...
  const handleResumeDownload = () => {
    try {
      ...
      const downloadLink = 'https://drive.google.com/uc?export=download&id=1KK6MZNntzPbGbMrHqj9TWK92-DaD61Nw';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            ...
            >
              {[
                { icon: Mail, action: () => handleContactClick('email', personalInfo.email) },
                { icon: Linkedin, action: () => handleContactClick('linkedin', personalInfo.linkedin) },
                { icon: Github, action: () => handleContactClick('github', 'github.com/crazygamer9597') },
              ].map((social, index) => (
                <motion.button
                  key={index}
